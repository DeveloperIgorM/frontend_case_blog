...
export default function ProfilePage() {
  const { user, loadingAuth, refreshUser } = useAuth(); 
  ...
  const handleRemoveAvatar = () => {
    ...
    toast.success("Avatar marcado para remoção.");
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    } else if (previewAvatar === null && formData.avatar_url !== null) {
    ...
    try {
      ...
      console.error("Erro ao atualizar perfil:", err.response?.data);
